        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
					...
					<option value=""></option>
					  <option value='RESERVATION' <c:if test="${c.dept eq 'RESERVATION' }">selected="selected"</c:if>>RESERVATION</option>
					  <option value='REVENUE' <c:if test="${c.dept eq 'REVENUE' }">selected="selected"</c:if>>REVENUE</option>
					  <option value='ROOMS' <c:if test="${c.dept eq 'ROOMS' }">selected="selected"</c:if>>ROOMS</option>
					  <option value='MANAGEMENT' <c:if test="${c.dept eq 'MANAGEMENT' }">selected="selected"</c:if>>MANAGEMENT</option>
					</select>
    			</div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
					...
					<option value=""></option>
					  <option value='SPECIALIST' <c:if test="${c.position eq 'SPECIALIST' }">selected="selected"</c:if>>SPECIALIST</option>
					  <option value='MANAGER' <c:if test="${c.position eq 'MANAGER' }">selected="selected"</c:if>>MANAGER</option>
					</select>
    			</div>
          </div>
