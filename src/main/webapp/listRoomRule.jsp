...
<body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="room_rule_list" title="刷新">
        <i class="layui-icon" style="line-height:30px">⥁</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" method="post" action="room_rule_search" onsubmit="return checkDate();">
                    <input type="text" class="layui-input" name="fromDate" id="fromDate" placeholder="搜索日期">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加房价规则','show_room_rule_add')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <c:forEach items="${cs}" var="c">
          <tr>
            ...
            <td >${c.num}</td>
			 <td class="td-manage">
              <a title="查看"  onclick="x_admin_show('编辑','room_rule_edit?id=${c.id}')" href="javascript:;">
                <i class="layui-icon">&#xe63c;</i>
              </a>
              <a deleteLink="true" title="删除" href="room_rule_delete?id=${c.id}"  >
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
			</tr>
