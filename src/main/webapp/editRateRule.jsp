      ...
      <div class="layui-input-inline">
        <select name="rateType" id="rateType" lay-verify="required" lay-search>
          ...
          <c:forEach items="${s}" var='b'>
          	 <option value='${b.code}' <c:if test="${b.code eq c.rateType}">selected="selected"</c:if>>${b.code}  - ${b.name}</option>
          </c:forEach>
        </select>
    </div>
          </div>
          ...
          <c:forEach items="${r}" var='b'>
          	 <option value='${b.code}' <c:if test="${b.code eq c.rmType}">selected="selected"</c:if>>${b.code}  - ${b.name}</option>
          </c:forEach>
        </select>
              </div>
          </div>
