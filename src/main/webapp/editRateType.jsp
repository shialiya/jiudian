...
<body>
<div class="x-body">
        <form id="addRateType" class="layui-form" method="post" action="rate_type_update" >
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
					<select name="prepaid" lay-verify="required">
					  <option value='false' <c:if test="${c.prepaid eq false }">selected="selected"</c:if>>不需要</option>
					  <option value='true'<c:if test="${c.prepaid eq true }">selected="selected"</c:if>>需要</option>
					</select>
    			</div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value=${c.freeCancelDate}>
              </div>
          </div>
          <div class="layui-form-item">
              <label  class="layui-form-label">
              ...
              <div class="layui-input-inline">
					<select name="isToAll" lay-verify="required">
					  <option value='false' <c:if test="${c.isToAll eq false }">selected="selected"</c:if>>不公开</option>
					  <option value='true' <c:if test="${c.isToAll eq true }">selected="selected"</c:if>>公开</option>
					</select>
    			</div>
          </div>
